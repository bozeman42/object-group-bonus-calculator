...
function displayTable() {
  if (tableState === false) {
    for (var i = 0; i < employees.length; i++) {
      ...
      var tableRow = "<tr class=\"dataRows\" ><td>" + employeeData.name + "</td><td>" + employeeData.bonusPercentage*100 + "%</td><td>$" + employeeData.totalCompensation + "</td><td>$" + employeeData.totalBonus + "</td></tr>";
